...
# Table of Contents
- [Part 8](#part-8)
  - [Part 8a - GraphQL - server](#part-8a---graphql---server)
    - [Schema and queries](#schema-and-queries)
    - [Apollo Server](#apollo-server)
    - [Apollo Studio Explorer](#apollo-studio-explorer)
    - [Parameters of a resolver](#parameters-of-a-resolver)
    - [The default resolver](#the-default-resolver)
    - [Object within an object](#object-within-an-object)
    - [Mutations](#mutations)
    - [Error handling](#error-handling)
    - [Enum](#enum)
    - [Changing a phone number](#changing-a-phone-number)
    - [More on queries](#more-on-queries)
    - [Named queries and variables](#named-queries-and-variables)
    - [Cache](#cache)
    - [Doing mutations](#doing-mutations)
    ...
    - [Apollo Client and the application state](#apollo-client-and-the-application-state)
    - [Exercises 8.1 - 8.7](#exercises-81---87)
      - [8.1: The number of books and authors](#81-the-number-of-books-and-authors)
      - [8.2 - All books](#82---all-books)
      - [All authors](#all-authors)
      - [8.4: Books of an author](#84-books-of-an-author)
      - [8.5: Books by genre](#85-books-by-genre)
      - [8.6: Adding a book](#86-adding-a-book)
      - [8.7: Updating the birth of an author](#87-updating-the-birth-of-an-author)
  - [Part 8b - React and GraphQL](#part-8b---react-and-graphql)
    ...
    - [Updating a phone number](#updating-a-phone-number)
    - [Apollo Client and the application state](#apollo-client-and-the-application-state)
    - [Exercises 8.8 - 8.12](#exercises-88---812)
      - [8.8: Authors view](#88-authors-view)
      - [8.9: Books view](#89-books-view)
      - [8.10: Adding a book](#810-adding-a-book)
      - [8.11: Authors birth year](#811-authors-birth-year)
      - [8.12: Authors birth year advanced](#812-authors-birth-year-advanced)
  - [Part 8c - Database and user administration](#part-8c---database-and-user-administration)
    - [Mongoose and Apollo](#mongoose-and-apollo)
    - [Validation](#validation)
    - [User and log in](#user-and-log-in)
