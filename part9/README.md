...
- [Part 9](#part-9)
  ...
  - [Part 9d - React with types](#part-9d---react-with-types)
    - [Vite with TypeScript](#vite-with-typescript)
    - [React components with TypeScript](#react-components-with-typescript)
    - [Exercise 9.15](#exercise-915)
    - [Deeper type usage](#deeper-type-usage)
    - [More type narrowing](#more-type-narrowing)
    - [Exercise 9.16](#exercise-916)
    - [React app with state](#react-app-with-state)
    - [Communicating with the server](#communicating-with-the-server)
    - [A note about defining object types](#a-note-about-defining-object-types)
    - [Exercises 9.17 - 9.20](#exercises-917---920)
      - [Exercise 9.17](#exercise-917)
      - [Exercise 9.18](#exercise-918)
      - [Exercise 9.19](#exercise-919)
      - [Exercise 9.20](#exercise-920)
  - [Part 9e - Grande finale: Patientor](#part-9e---grande-finale-patientor)
    - [Working with an existing codebase](#working-with-an-existing-codebase)
    - [Patientor frontend](#patientor-frontend)
    - [Exercises 9.21 - 9.22](#exercises-921---922)
      - [9.21: Patientor, step 1](#921-patientor-step-1)
      - [9.22: Patientor, step2](#922-patientor-step2)
    - [Full entries](#full-entries)
    - [Omit with unions](#omit-with-unions)
    - [Exercises 9.23 - 9.30](#exercises-923---930)
      - [9.23: Patientor, step 3](#923-patientor-step-3)
      - [9.24: Patientor, step 4](#924-patientor-step-4)
      - [9.25: Patientor, step 5](#925-patientor-step-5)
      - [9.26: Patientor, step 6](#926-patientor-step-6)
      - [9.27: Patientor, step 7](#927-patientor-step-7)
      - [9.28: Patientor, step 8](#928-patientor-step-8)
      - [9.29: Patientor, step 9](#929-patientor-step-9)
      - [9.30: Patientor, step 10](#930-patientor-step-10)
...
## Part 9e - Grande finale: Patientor
...
It's time to get our hands dirty finalizing the frontend for the backend we built in [exercises 9.8.-9.13](#part-9c---typing-an-express-app). We will actually also need some new features to the backend for finishing the app.
...
There is nothing too surprising in the code. The state and communication with the backend are implemented with `useState` hook and Axios, similar to the notes app in the previous section. [Material UI](../part7/README.md#material-ui) is used to style the app and the navigation structure is implemented with [React Router](../part7/README.md#react-router), both familiar to us from part 7 of the course.
...
In this exercise, you quite likely need to remember [this trick](#omit-with-unions).
...
Now that our backend supports adding new entries, we want to add the corresponding functionality to the frontend. In this exercise, you should add a form for adding an entry to a patient. An intuitive place for accessing the form would be on a patient's page.

In this exercise, it is enough to __support one entry type__. All the fields in the form can be just plain text inputs, so it is up to the user to enter valid values. 

Upon a successful submission the new entry should be added to the correct patient and the patient's entries on the patient page should be updated to contain in the new entry. 

Your form might look something like this:

![alt text](assets/image56.png)

If a user enters invalid values to the form a backend rejects the addition, show a proper error message to the user
