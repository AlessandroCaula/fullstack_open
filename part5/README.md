...
- [Part 5](#part-5)
  - [Part 5a - Login in fronted](#part-5a---login-in-fronted)
    ...
    - [Exercise 5.1-5.4](#exercise-51-5-4)
      - [5.1: Blog List Frontend, step 1](#51-blog-list-frontend-step-1)
      - [Exercise 5.2: Blog List Frontend, step 2](#exercise-52-blog-list-frontend-step-2)
      - [Exercise 5.3: Blog List Frontend, step 3](#exercise-53-blog-list-frontend-step-3)
      - [Exercise 5.4: Blog List Frontend, step 4](#exercise-54-blog-list-frontend-step-4)
  ...
  - [Part 5d - End to end testing: Playwright](#part-5d---end-to-end-testing-playwright)
    - [Playwright](#playwright)
    - [Initializing tests](#initializing-tests)
    - [Testing our own code](#testing-our-own-code)
    - [Writing on the form](#writing-on-the-form)
    - [Testing note creation](#testing-note-creation)
    - [Controlling the state of the database](#controlling-the-state-of-the-database)
    - [Test for failed login](#test-for-failed-login)
    - [Running tests one by one](#running-tests-one-by-one)
    - [Helper functions for tests](#helper-functions-for-tests)
    - [Note importance change revisited](#note-importance-change-revisited)
    - [Test development and debugging](#test-development-and-debugging)
    - [Exercise 5.17 - 5.23](#exercise-517---523)
      - [7.17: Blog List End to End Testing, step 1](#717-blog-list-end-to-end-testing-step-1)
      - [5.18: Blog List End To End Testing, step 2](#518-blog-list-end-to-end-testing-step-2)
      - [5.19: Blog List End To End Testing, step 3](#519-blog-list-end-to-end-testing-step-3)
      - [5.20: Blog List End To End Testing, step 4](#520-blog-list-end-to-end-testing-step-4)
      - [5.21: Blog List End To End Testing, step 5](#521-blog-list-end-to-end-testing-step-5)
      - [5.22: Blog List End To End Testing, step 6](#522-blog-list-end-to-end-testing-step-6)
      - [5.23: Blog List End To End Testing, step 7](#523-blog-list-end-to-end-testing-step-7)
